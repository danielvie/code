    ...
    <div className="dashboard">
      <aside className="sidebar">
          ...
          <div className="status" style={{display: 'flex', justifyContent: 'space-between'}}>
            <div style={{display: 'flex', alignItems: 'center', gap: '0.5rem'}}>
              <div
                ...
                title={connected ? (isValid ? 'Connected — simulation running' : 'Connected — stability failure') : 'Disconnected from backend'}
              />
              <span>{connected ? (isValid ? 'System Stable' : 'Stability Failure') : 'Disconnected'}</span>
            </div>
            {connected && <div className="pps-badge" title="Packets Per Second">{pps} PPS</div>}
          </div>
        </div>
        ...
        <div className="sidebar-footer">
          <div className="control-item">
            <label style={{paddingLeft: '1.25rem', paddingRight: '1.25rem'}}>Chart (pos)</label>
